...
class LegalInfoScreen extends StatelessWidget {
  ...
  String _t(String key) {
    final translations = {
      ...
      'rules': { 'Русский': 'Правила безопасности', 'Қазақша': 'Қауіпсіздік ережелері', 'Уйғурчә': 'Бехатарлик қаидилири' },
        ...
        child: Column(
          children: [
            _buildLegalCard(
              ...
              title: _t('tos'),
              content: LegalTexts.getTermsOfService(lang),
            ...
            _buildLegalCard(
              ...
              title: _t('rules'),
              content: LegalTexts.getPublicationRules(lang),
