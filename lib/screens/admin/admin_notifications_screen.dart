      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildTextField('Заголовок рассылки', _titleController, PhosphorIcons.textT(), maxLength: 100),
            const SizedBox(height: 16),
            _buildTextField('Текст Push-уведомления', _bodyController, PhosphorIcons.textAlignLeft(), maxLines: 6, maxLength: 1000),
            const SizedBox(height: 28),
