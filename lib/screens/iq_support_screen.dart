...
class _IqSupportScreenState extends State<IqSupportScreen>
  ...
  String _t(String key) {
    const t = <String, Map<String, String>>{
      ...
      'welcome_market': {
        'RU': 'Привет! 👋 Я IQ-Поддержка — ваш персональный ИИ-помощник по IQ-Market.\n\nЗадавайте вопросы по приложению — они абсолютно безлимитны! На общие посторонние темы действует лимит: 3 вопроса в день. 🚀',
        'KZ': 'Сәлем! 👋 Мен IQ-Қолдау — IQ-Market бойынша жеке көмекшіңізбін.\n\nҚосымша бойынша сұрақтар — мүлдем шектеусіз! Жалпы басқа тақырыптарға лимит бар: күніне 3 сұрақ. 🚀',
        'UG': 'Мәрһәба! 👋 Мән IQ-Йардәм — IQ-Market бойичә шәхсий йардәмчиңизмән.\n\nПрограмма бойичә соаллар — толуқ чәклимсиз! Башқа мавзуларға күнлүк лимит бар: 3 соал. 🚀',
      },
      'welcome_taxi': {
        'RU': 'Привет! 🚕 Я IQ-Поддержка Такси — помогу с любым вопросом по IQ-Taxi.\n\nВопросы по такси — безлимитно! На сторонние темы действует лимит: 3 вопроса в день. 💫',
        'KZ': 'Сәлем! 🚕 Мен IQ-Қолдау Такси — IQ-Taxi бойынша кез келген сұраққа жауап беремін.\n\nТакси бойынша сұрақтар — шектеусіз! Басқа тақырыптарға лимит бар: күніне 3 сұрақ. 💫',
        'UG': 'Мәрһәба! 🚕 Мән IQ-Йардәм Такси — IQ-Taxi бойичә йардәм беримән.\n\nТакси бойичә соаллар — чәклимсиз! Башқа мавзуларға күнлүк лимит бар: 3 соал. 💫',
      },
      'wa_msg': {
