  ...
  static final List<CategoryModel> categories = [
    CategoryModel(
      ...
      subCategories: [
        ...
        SubCategoryModel(id: 'parts', ru: 'Запчасти', kz: 'Қосалқы бөлшектер', ug: 'Запас қисмлар'),
    ...
    CategoryModel(
      ...
      subCategories: [
        ...
        SubCategoryModel(id: 'strollers', ru: 'Коляски', kz: 'Арбалар', ug: 'Һарва'),
      ],
    ),
    CategoryModel(
      id: 'Недвижимость', 
      ...
      color: const Color(0xFF4A80F0),
      subCategories: [
        SubCategoryModel(id: 'apartments', ru: 'Квартиры', kz: 'Пәтерлер', ug: 'Пәтерләр'),
        SubCategoryModel(id: 'houses', ru: 'Дома', kz: 'Үйлер', ug: 'Өйләр'),
        SubCategoryModel(id: 'land', ru: 'Участки', kz: 'Жер учаскелері', ug: 'Йәр участоклири'),
        SubCategoryModel(id: 'commercial', ru: 'Коммерческая', kz: 'Коммерциялық', ug: 'Тиҗарәт орунлири'),
      ],
    ),
    CategoryModel(
      id: 'Сельхоз и Корма', 
      ...
      subCategories: [
        ...
        SubCategoryModel(id: 'machinery', ru: 'Сельхозтехника', kz: 'Ауыл шаруашылық техникасы', ug: 'Деҳқанчилиқ техникаси'),
      ],
    ),
    CategoryModel(
      id: 'Стройматериалы', 
      ru: 'Стройматериалы', 
      kz: 'Құрылыс материалдары', 
      ug: 'Қурулуш материаллири', 
      icon: Icons.construction_rounded, 
      color: const Color(0xFFF59E0B),
      subCategories: [
        SubCategoryModel(id: 'lumber', ru: 'Лес и Брус', kz: 'Ағаш материалдары', ug: 'Яғач'),
        SubCategoryModel(id: 'cement', ru: 'Цемент и Кирпич', kz: 'Цемент пен кірпіш', ug: 'Цемент вә ғишт'),
